...
public class DirecaoDAO {
	...
	public ArrayList<Direcao> SelectAll(int id_processo) throws SQLException {
		...
		while (resultado.next()) {
			...
			direcao.setId_conexao_origem(resultado.getInt("id_conn_origin"));
			direcao.setId_conexao_destino(resultado.getInt("id_conn_dest"));
